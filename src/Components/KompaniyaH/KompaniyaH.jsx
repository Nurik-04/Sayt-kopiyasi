      ...
      <div className="contayner">
        <div className="kompaniya__contayner">
          ...
          <div className="xizmatlar">
            <h2 className="xizmatlar__title">Bizning Tariximiz</h2>
            <p className="xizmatlar__text">IFLY kompaniyasi tashkil etilganidan beri mijozlarga unutilmas sayohat tajribalarini taqdim etmoqda. Biz har doim eng yaxshi xizmatlarni ko'rsatishga intilamiz va mijozlarimizning istak va ehtiyojlarini e'tiborga olamiz.</p>
            <a href="#">Batafsil o'qing →</a>
          </div>
